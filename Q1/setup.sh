...
[ ! -f "$PROJECT_ROOT/src/FacultyParser.cpp" ] && touch "$PROJECT_ROOT/src/FacultyParser.cpp"
...
[ ! -f "$PROJECT_ROOT/include/PublicationsDatabase.h" ] && touch "$PROJECT_ROOT/include/PublicationsDatabase.h"
[ ! -f "$PROJECT_ROOT/include/BibParser.h" ] && touch "$PROJECT_ROOT/include/BibParser.h"
[ ! -f "$PROJECT_ROOT/include/FacultyParser.h" ] && touch "$PROJECT_ROOT/include/FacultyParser.h"
